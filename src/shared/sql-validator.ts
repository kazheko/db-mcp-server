import type { QueryAdapter } from './queries.js';
...
export const validateSqlRequest = <TRequest extends SqlValidationRequest>(
  request: TRequest,
...
export const withSqlValidation = <TRequest extends SqlValidationRequest, TResult>(
  adapter: QueryAdapter<TRequest, TResult>,
  policy: ValidationPolicy
): QueryAdapter<TRequest, TResult> => ({
  async execute(request) {
    validateSqlRequest(request, policy);
